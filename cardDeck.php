<?php 
	...
	<!--sql values-->
				<?php
						$qr=mysqli_query($cn,"select * from foodies1 where category='Indian Cuisine' order by title");
            ...
            <div class="card-wrapper">
              ...
              <div id="<?php  echo $urow['id']; ?>" class="card-rotating effect__click text-center h-100 w-100">
                ...
                <div class="face front">
				  <div class="card-body  peach-gradient" style="width: 20rem;">
                  ...
                  <div class="card-body">
                    ...
                    <p class="font-weight-bold white-text"><?php echo $urow['content']; ?></p>
                    <!-- Triggering button -->
                ...
                <!-- Back Side -->
                <div class="face back" >
                  <div class="card-body  dusty-grass-gradient black-text" style="width: 50rem;">

                    <!-- Content -->
                    <h4 class="font-weight-bold mb-0"></h4>
                    <hr>
                    <p class="font-weight-bold"><?php echo $urow['extra']; ?></p>
                    <hr>
                    <!-- Social Icons -->
