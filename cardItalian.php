<?php 
	...
	<!--sql values-->
				<?php
						$qr=mysqli_query($cn,"select * from foodies1 where category='Italian Cuisine' and id not in(37,38,36) order by title");
            ...
            <div class="card-wrapper ">
              <div id="<?php  echo $urow['id']; ?>" class="card-rotating effect__click text-center h-100 w-100">
                ...
                <div class="face front">
				  <div class="card-body  aqua-gradient" style="width: 20rem;">
                ...
                <!-- Back Side -->
                <div class="face back" >
                  <div class="card-body  blue-gradient white-text" style="width: 50rem;">
